...
- Modify `src/sp_stock_agent/config/agents.yaml` to define your agents
- Modify `src/sp_stock_agent/config/tasks.yaml` to define your tasks
- Modify `src/sp_stock_agent/crew.py` to add your own logic, tools and specific args
- Modify `src/sp_stock_agent/main.py` to add custom inputs for your agents and tasks
